...
class Calculator:
    def __init__(self,conduct):
        conduct.title("Calculator")
        conduct.geometry('357x429+0+0')
        conduct.config(bg="gray")
        conduct.resizable(False,False)
        ...
        Button(width=11, height=4, text='-', relief='flat',bg='white', command=lambda:self.show('-')).place(x=270,y=270)
        ...
        Button(width=11, height=4, text='=', relief='flat',bg='red', command=self.solve).place(x=270,y=350)
